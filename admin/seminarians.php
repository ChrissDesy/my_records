<?php
    ...
    include('./controllers/seminariansCon.php');
...
<link rel="shortcut icon" href="../dist/img/AdminLTELogo.png"/>
  ...
  <title>MyRECORDS | Seminarians</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Seminarians</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Seminarians</a></li>
                            <li class="breadcrumb-item active">All Seminarians</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6"><h3 class="card-title">List of Seminarians</h3></div>
                    ...
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Education
                                    <textarea name="education" class="form-control" placeholder="Type here.." required cols="30" rows="7"></textarea>
                                </div>
                            </div>
                        </div>
                        <br><br>
                    ...
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Education
                                    <textarea name="education" id="eeduc" class="form-control" placeholder="Type here.." required cols="30" rows="7"></textarea>
                                </div>
                            </div>
                        </div>
                        <br><br>
