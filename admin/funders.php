<?php
    ...
    include('./controllers/fundersCon.php');
    ...
    //get employees
    $sql = "SELECT 
            f.id, name, project, term, title, location
            FROM funders AS f
            INNER JOIN projects AS p ON f.project = p.id";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Funders</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Funders</a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6"><h3 class="card-title">List of Funders</h3></div>
                    ...
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Term
                                    <input type="text" name="term" required placeholder="Term" class="form-control">
                                </div>
                            </div>
                        </div>
                        <br><br>
                    ...
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Project
                                    <select name="project" id="eproject" class="form-control" required>
                                        <option value="" selected disabled>choose...</option>
                                        <?php foreach ($result2 as $r) { ?>
                                            <option value="<?php echo $r['id']; ?>"><?php echo $r['title']; ?></option>
                                        <?php } ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Term
                                    <input type="text" name="term" id="eterm" required placeholder="Term" class="form-control">
                                </div>
                            </div>
                        </div>
                        <br><br>
