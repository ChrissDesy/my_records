<?php
    ...
    include('./controllers/priestsCon.php');
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Priests</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Priests</a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6"><h3 class="card-title">List of Priests</h3></div>
                                    ...
                                    <tbody>
                                        <?php foreach ($result as $r) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $r['baptism']; ?></td>
                                                <td><?php echo $r['ordination']; ?></td>
                    ...
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Surname
                                    <input type="text" name="sname" required placeholder="Surname" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Baptism
                                    <input type="date" name="baptism" required class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    Ordination
                                    <input type="date" name="ordination" required class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    Confirmation
                                    <input type="text" name="confirmation" placeholder="Confirmation" required class="form-control">
                                </div>
                            </div>
                        </div>
                        <br><br>
                    ...
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Surname
                                    <input type="text" name="sname" id="esnamee" required placeholder="Surname" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    DOB
                                    <input type="date" name="dob" id="edob" required class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    Baptism
                                    <input type="date" name="baptism" id="ebaptism" required class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    Ordination
                                    <input type="date" name="ordination" id="eord" required class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    Confirmation
                                    <input type="text" name="confirmation" id="econf" placeholder="Confirmation" required class="form-control">
                                </div>
                            </div>
                        </div>
                        <br><br>
    ...
    <script>
        ...
        $("#edit").on('show.bs.modal', function (e) {
            ...
            $('#ename').val(info.name);
            $('#esnamee').val(info.surname);
            $('#ebaptism').val(info.baptism);
            $('#edob').val(info.dob);
            $('#eord').val(info.ordination);
            $('#econf').val(info.confirmation);
