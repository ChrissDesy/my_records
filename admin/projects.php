<?php
    ...
    include('./controllers/projectsCon.php');
...
<link rel="shortcut icon" href="../dist/img/AdminLTELogo.png"/>
  ...
  <title>MyRECORDS | Projects</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6"><h3 class="card-title">List of Projects</h3></div>
                    ...
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Responsible
                                    <input type="text" name="responsible" required placeholder="Responsible" class="form-control">
                                </div>
                            </div>
                        </div>
                        <br><br>
                    ...
                    <form method="post">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    Responsible
                                    <input type="text" name="responsible" id="eRespon" required placeholder="Responsible" class="form-control">
                                </div>
                            </div>
                        </div>
                        <br><br>
